          ...
          >
            <div style={{ minHeight: '38em', fontFamily: 'Helvetica, Arial, sans-serif' }}>
              {!data && !error ? (
                ...
                <SpaceBetween size="l">
                  <ValueWithLabel key='issues' label="Issue" style={{ fontFamily: 'Helvetica, Arial, sans-serif' }}>
                    {issuesTab()}
                  </ValueWithLabel>
                  <ValueWithLabel key='actionItems' label="Action Items" style={{ fontFamily: 'Helvetica, Arial, sans-serif' }}>
                    {actionItemsTab()}
                  </ValueWithLabel>
